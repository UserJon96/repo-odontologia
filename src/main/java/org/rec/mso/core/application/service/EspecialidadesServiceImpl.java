...
import org.rec.mso.core.adapter.out.persistence.IEspecialidadesRepository;
import org.rec.mso.core.domain.port.in.EspecialidadesService;
...
public class EspecialidadesServiceImpl implements EspecialidadesService {
    ...
    @Autowired
    private IEspecialidadesRepository repository;
    ...
    @Transactional(readOnly = true)
    @Override
    public Especialidade getForId(@NonNull Integer id) {
    ...
    @Transactional
    @Override
    public RsTrxService register(Especialidade body) {
        try {
    ...
    @Transactional
    @Override
    public RsTrxService update(Especialidade body) {
        try {
            repository.save(body);
