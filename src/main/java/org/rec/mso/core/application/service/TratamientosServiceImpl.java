...
import org.rec.mso.core.adapter.out.persistence.ITratamientosRepository;
...
public class TratamientosServiceImpl implements TratamientosService {
    ...
    @Autowired
    private ITratamientosRepository repository;
    ...
    @Transactional(readOnly = true)
    @Override
    public Tratamiento getForId(@NonNull Integer id) {
    ...
    @Transactional
    @Override
    public RsTrxService register(Tratamiento body) {
        try {
    ...
    @Transactional
    @Override
    public RsTrxService update(Tratamiento body) {
        try {
            repository.save(body);
